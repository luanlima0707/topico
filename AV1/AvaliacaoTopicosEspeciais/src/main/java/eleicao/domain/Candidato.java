...
@GeneratedValue(strategy=GenerationType.IDENTITY)
	...
	public String getNomeCanditato() {
		return nomeCanditato;
	}

	public void setNomeCanditato(String nomeCanditato) {
	...
	public int hashCode() {
		...
		result = prime * result + ((nomeCanditato == null) ? 0 : nomeCanditato.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (id == null) {
			...
			return false;
		if (nomeCanditato == null) {
			if (other.nomeCanditato != null)
				return false;
		} else if (!nomeCanditato.equals(other.nomeCanditato))
			return false;
	...
	public String toString() {
		return "Candidato [id=" + id + ", nomeCanditato=" + nomeCanditato + ", numeroCandidato=" + numeroCandidato
